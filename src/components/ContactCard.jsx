...
const ContactCard = ({ price, email, phone }) => {
    ...
    return (
        <div className='ContactCard'>
            ...
            <a href={Numerphone} target="_blank" className='ContactCard__button'>WhatsApp <AiOutlineWhatsApp size={23} /> </a>
            <a href={mail} target="_blank" className='ContactCard__button'>Mail <AiOutlineMail size={23} /> </a>
        </div>
    );
}
